...
export default function Accountant() {
  ...
  const filteredLedger = ledger.filter(tx => {
    ...
    const matchDate = isDateInRange(tx.date || tx.createdAt, ledgerStartDate, ledgerEndDate);
    ...
    <div style={{ padding: '1.75rem', fontFamily: "'Inter', system-ui, sans-serif", color: '#0f172a' }}>
      ...
      {activeTab === 'ledger' && (
        <div style={{ backgroundColor: '#ffffff', border: '1px solid #e2e8f0', borderRadius: '16px', padding: '1.5rem', boxShadow: '0 2px 6px rgba(15,23,42,0.03)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem', flexWrap: 'nowrap', gap: '1rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'nowrap', flexShrink: 0 }}>
              ...
              <div style={{
                ...
                alignItems: 'center',
                gap: '0.4rem',
                backgroundColor: (ledgerStartDate || ledgerEndDate) ? '#eff6ff' : '#ffffff',
                border: (ledgerStartDate || ledgerEndDate) ? '1px solid #2563eb' : '1px solid #cbd5e1',
                borderRadius: '10px',
          ...
          <div style={{ border: '1px solid #e2e8f0', borderRadius: '12px', overflowX: 'auto', minHeight: '380px' }}>
